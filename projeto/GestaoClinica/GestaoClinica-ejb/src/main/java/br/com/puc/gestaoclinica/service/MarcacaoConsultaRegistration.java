...
@Stateless
public class MarcacaoConsultaRegistration {

    @Inject
    private EntityManager em;

    @Inject
    private Event<MarcacaoConsulta> marcarEventSrc;

    public void cadastrar(MarcacaoConsulta marcacaoConsulta) throws Exception {
