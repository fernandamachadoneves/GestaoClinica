...
@Stateless
public class ConfiguracaoHorarioProfissionalRegistration {
    ...
    @Inject
    private Event<ConfiguracaoHorarioProfissional> configEventSrc;

    public void cadastrar(ConfiguracaoHorarioProfissional config) throws Exception {
        em.persist(config);
